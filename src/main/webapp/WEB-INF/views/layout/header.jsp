...
<body>
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark">
		<a class="navbar-brand" href="${contextPath}">블로그</a>
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			...
			<c:choose>
				<c:when test="${empty principal }">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link" href="${contextPath}/auth/loginForm">로그인</a></li>
						<li class="nav-item"><a class="nav-link" href="${contextPath}/auth/joinForm">회원가입</a></li>
					</ul>
				</c:when>
				<c:otherwise>
					<ul class="navbar-nav">
